...
api: 'GET https://app.tryiris.dev/api/trpc/test.findFirst'
authentication: true
---
...
<ParamField query="include" type="object">
  Specify related data to include in the response
  
  <Expandable title="Include Object Properties">
...
curl 'https://app.tryiris.dev/api/trpc/test.findFirst' \
